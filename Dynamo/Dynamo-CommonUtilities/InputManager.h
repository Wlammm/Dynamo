...
namespace CommonUtilities
{
	...
	public:
		...
		// The frame the user pressed the button.
		bool IsKeyDown(const KeyCode aKeyCode);
		// The frame the user pressed the button.
		bool IsKeyDown(const MouseButton aMouseButton);

		// The frame the user released the button.
		bool IsKeyUp(const int aKeyCode);
		// The frame the user released the button.
		bool IsKeyUp(const KeyCode aKeyCode);
		// The frame the user released the button.
		bool IsKeyUp(const MouseButton aMouseButton);

		// The frames the user is pressing the button.
		bool IsKeyPressed(const int aKeyCode);
		// The frames the user is pressing the button.
		bool IsKeyPressed(const KeyCode aKeyCode);
		// The frames the user is pressing the button.
		bool IsKeyPressed(const MouseButton aMouseButton);
	...
	private:
		int GetRightOrLeftKeyCode(const int aVirtualKeyCode, const LPARAM lParam);
...
using KeyCode = CU::InputManager::KeyCode;
using MouseButton = CU::InputManager::MouseButton;